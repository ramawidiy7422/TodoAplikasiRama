...
import com.example.todoaplikasirama.databinding.TampilanIsianBinding
...
{
    private lateinit var binding: TampilanIsianBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        {
            binding.taskTitle.text = "TAMBAHKAN TASK"
        }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = TampilanIsianBinding.inflate(inflater,container,false)
        return binding.root
    }
